...
class Connect(nn.Module):
    def __init__(self, num_classes, num_neighbor, BatchNorm, reduction=3):
        ...
        # self.seg_branch = nn.Conv2d(64, 64, 3, stride=1, padding=1)


        self.connect_branch = nn.Conv2d(32, num_neighbor, 3, padding=1, dilation=1)

        self.se = SELayer(num_neighbor, reduction)

        self.connect_branch_d1 = nn.Conv2d(32, num_neighbor, 3, padding=3, dilation=3)
